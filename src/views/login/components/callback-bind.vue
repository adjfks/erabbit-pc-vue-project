  ...
  <Form ref="formCom" :validation-schema="mySchema" v-slot="{ errors }" autocomplete="off" class="xtx-form">
    ...
    <div class="xtx-form-item">
      <div class="field">
        ...
        <Field :class="{ error: errors.mobile }" v-model="form.mobile" name="mobile" class="input" type="text" placeholder="绑定的手机号" />
      </div>
    ...
    <div class="xtx-form-item">
      <div class="field">
        ...
        <Field :class="{ error: errors.code }" v-model="form.code" name="code" class="input" type="text" placeholder="短信验证码" />
